...
namespace Town
{
	...
	/// 店UI
	/// 
	/// 使い回されない（：店に入るタイミングで生成され→出るときに破棄される）ことが前提の実装になっている
	/// </summary>
	class TownScene::Shop_UI final : public GUI::IGUI
	{
	public:
		Shop_UI( TownScene &Outer );
		~Shop_UI();
	...
	public:	// IGUI Impl
		...
		virtual Shop_UI &TopLeft( const Vec2i &TL ) override {	return *this;	}	//※使わないのでDummy実装
